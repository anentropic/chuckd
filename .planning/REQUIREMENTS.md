...
- [ ] **VAL-01**: User can specify schema file and one or more previous schema file paths for comparison
- [ ] **VAL-02**: Action maps format, compatibility, and log-level inputs to chuckd CLI flags
